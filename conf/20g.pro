...
hdfs.source.file.input.path=hdfs://ip-172-31-12-149.us-west-2.compute.internal:8020/user/nci/bltest
...
hbase.generated.hfiles.output.path=hdfs://ip-172-31-12-149.us-west-2.compute.internal:8020/user/nci/bltest_hfile
hbase.target.table.name=nci20gb
