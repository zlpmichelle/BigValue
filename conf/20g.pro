...
hdfs.source.file.input.path=hdfs://ip-172-31-12-149.us-west-2.compute.internal:8020/user/example3/bltest
...
hbase.generated.hfiles.output.path=hdfs://ip-172-31-12-149.us-west-2.compute.internal:8020/user/example3/bltest_hfile
hbase.target.table.name=example320gb
