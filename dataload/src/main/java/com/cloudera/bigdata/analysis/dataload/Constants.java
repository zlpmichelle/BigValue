...
public class Constants {
  ...
  public final static String MAPRED_JOB_TRACKER_KEY = "mapreduce.job.tracker";

  public final static String MAPRED_JOBTRACKER_PORT_KEY = "mapreduce.job.tracker.port";
  ...
  public static final String CDH_HBASE_MASTER_IPADDRESS = "cdh.hbase.master.ip.address";
