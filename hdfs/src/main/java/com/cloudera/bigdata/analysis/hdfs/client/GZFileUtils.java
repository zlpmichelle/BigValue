package com.cloudera.bigdata.analysis.hdfs.client;
...
public class GZFileUtils {
  ...
  private static final String USAGE_STR = "com.cloudera.bigdata.analysis.dataload.util.GZFileUtils <inputGZDir> <hdfsDir> <hdfsGZSize> <workerThreads>";
